...
const downloadJSFolder = (output, url) => {
    return downloadFiles(url, [
        ...
        'js/masters/modules/gantt.src.js',
        'js/masters/modules/grid-axis.src.js',
        ...
        'js/masters/modules/xrange-series.src.js',
        ...
        'js/modules/gantt.src.js',
        'js/modules/grid-axis.src.js',
        ...
        'js/modules/xrange-series.src.js',
        ...
        'js/parts-gantt/gantt.js',
        'js/parts-gantt/grid-axis.js',
        'js/parts-gantt/xrange-series.js',
